...
<body>
	...
	<div class="container card form_container"
		...
		<form class="form" action="submitTrader" method=post
			...
			<div class="form-row" style="width: 550px">
				...
				<div class="form-group col-md-12">
					<label for="inputMobile">Mobile</label> <input type="tel"
						class="form-control" name="mobileNo" placeholder="XXXXXXXXXX"
						required>
				</div>
				<div class="form-group col-md-12">
				...
				<div class="form-group col-md-12">
					<label for="inputAddress">Address</label> <input type="text"
						class="form-control" name="addressLine" placeholder="1234 Main St">
				</div>
			</div>
			...
			<div class="form-row" style="width: 550px;">
				...
				<div class="form-group col-md-12">
					<label for="inputAccNo">Account No.</label> <input type="text"
						class="form-control" name="accNo" placeholder="XXXXXXXXXXXX">
				</div>
				<div class="form-group col-md-12">
					<label for="inputIFSC">IFSC Code</label> <input type="text"
						class="form-control" name="iFSC" placeholder="XXXXXXXXXXX">
				</div>
				<!-- <div class="form-group col-md-12">
			...
			<div class="form-group">
				<div class="form-check">
					<p>
						Already a user? Skip to <a class="login_ref" href="login.html"
